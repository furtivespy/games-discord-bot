class Help {
    async execute(interaction, client) {
        await interaction.reply({
            content: `🪙 **Welcome to the Token Treasury!** 🪙
...
*   **/tokens create** 🧸 - Got a brilliant idea for a new token? This command lets you create a new type of token. Let your imagination run wild! What will you dream up?
...
*   **/tokens check** 🤔 - Curious about the current token situation? Check the token counts. How many do you have? Are you swimming in tokens or running low?
