...
const bloodRageAge3 = [
    {name: `Thor's Conquest`, type: `Clan`, suit: `Clan`, description: `Gain 3 glory for each figure you have on the board at the end of the game.`, url: `https://furtivespy.com/images/bloodrage/age3_0_1`},
    //{name: `Thor's Chosen`, type: `Monster`, suit: `Monster`, description: `Add 1 mystic to your reserve. Each time you win a battle, gain 3 glory for eahc of your participating mystics.`, url: `https://furtivespy.com/images/bloodrage/age3_0_2`},
    {name: `Heimdall's Watch`, type: `Battle`, suit: `Battle`, description: `Discard all revealed cards. Gain glory equal to the total +STR revealed. Then play new cards.`, url: `https://furtivespy.com/images/bloodrage/age3_0_3`},
    {name: `Alfheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Alfheim (gray) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_0_4`},
    {name: `Soldier of Hel`, type: `Monster`, suit: `Monster`, description: `*Costs no rage to upgrade or invade`, url: `https://furtivespy.com/images/bloodrage/age3_0_5`},
    {name: `Lord of Spears`, type: `Leader`, suit: `Leader`, description: `If you successfully pillage with your leader, raise all your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_0_6`},
    {name: `Heimdall's Gaze`, type: `Battle`, suit: `Battle`, description: `You may play this card (and add its STR) after all players' battle cards are revealed.`, url: `https://furtivespy.com/images/bloodrage/age3_0_7`},
    {name: `Thor's Primacy`, type: `Battle`, suit: `Battle`, description: `Cancel the text of each opponent's revealed card before it takes effect.`, url: `https://furtivespy.com/images/bloodrage/age3_0_8`},
    {name: `Manheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Manheim (yellow) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_0_9`},

    {name: `Tyr's Wrath`, type: `Clan`, suit: `Clan`, description: `After you reveal a quest card in combat, you may treat it as a +5 battle card.`, url: `https://furtivespy.com/images/bloodrage/age3_1_0`},
    {name: `Heimdall's Gaze`, type: `Battle`, suit: `Battle`, description: `You may play this card (and add its STR) after all players' battle cards are revealed.`, url: `https://furtivespy.com/images/bloodrage/age3_1_1`},
    {name: `Tyr's Crush`, type: `Battle`, suit: `Battle`, description: `-`, url: `https://furtivespy.com/images/bloodrage/age3_1_2`},
    {name: `Volur Witch`, type: `Monster`, suit: `Monster`, description: `May retreat from an outer province to Yggdrasil instead of being destroyed.`, url: `https://furtivespy.com/images/bloodrage/age3_1_3`},
    {name: `Loki's Poison`, type: `Battle`, suit: `Battle`, description: `If you lose, take the winning player's revealed cards into your hand.`, url: `https://furtivespy.com/images/bloodrage/age3_1_4`},
    {name: `Loki's Wrath`, type: `Clan`, suit: `Clan`, description: `Gain 3 glory for each figure you release from Valhalla.`, url: `https://furtivespy.com/images/bloodrage/age3_1_5`},
    {name: `Jotunheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Jotunheim (blue) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_1_6`},
    {name: `Manheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Manheim (yellow) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_1_9`},

    {name: `Odin's Judgement`, type: `Battle`, suit: `Battle`, description: `Gain 2 glory for each figure destroyed in this battle (including yours).`, url: `https://furtivespy.com/images/bloodrage/age3_2_1`},
    //{name: `Thor's Chosen`, type: `Monster`, suit: `Monster`, description: `Add 1 mystic to your reserve. Each time you win a battle, gain 3 glory for eahc of your participating mystics.`, url: `https://furtivespy.com/images/bloodrage/age3_2_4`},
    {name: `Thor's Ascension`, type: `Battle`, suit: `Battle`, description: `If you win, gain 3 rage and 3 glory.`, url: `https://furtivespy.com/images/bloodrage/age3_2_5`},
    {name: `Tyr's Smite`, type: `Battle`, suit: `Battle`, description: `-`, url: `https://furtivespy.com/images/bloodrage/age3_2_6`},
    {name: `Masters in Arms`, type: `Warrior`, suit: `Warrior`, description: `*Each pair of your warriors in a province is 6 total STR.`, url: `https://furtivespy.com/images/bloodrage/age3_2_7`},
    {name: `Glorious Death`, type: `Quest`, suit: `Quest`, description: `Have at least 4 figures in Valhalla (before Ragnarok). If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_2_9`},

    {name: `Frost Giant`, type: `Monster`, suit: `Monster`, description: `If you successfully pillage with this monster, gain the pillage reward again.`, url: `https://furtivespy.com/images/bloodrage/age3_3_0`},
    {name: `Thor's Primacy`, type: `Battle`, suit: `Battle`, description: `Cancel the text of each opponent's revealed card before it takes effect.`, url: `https://furtivespy.com/images/bloodrage/age3_3_1`},
    {name: `Alfheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Alfheim (gray) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_3_2`},
    {name: `Glorious Death`, type: `Quest`, suit: `Quest`, description: `Have at least 4 figures in Valhalla (before Ragnarok). If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_3_3`},
    {name: `Thor's Ascension`, type: `Battle`, suit: `Battle`, description: `If you win, gain 3 rage and 3 glory.`, url: `https://furtivespy.com/images/bloodrage/age3_3_4`},
    {name: `Odin's Judgement`, type: `Battle`, suit: `Battle`, description: `Gain 2 glory for each figure destroyed in this battle (including yours).`, url: `https://furtivespy.com/images/bloodrage/age3_3_5`},
    {name: `Yggdrasil`, type: `Quest`, suit: `Quest`, description: `Have the most STR in Yggdrasil. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_3_6`},
    {name: `Jotunheim`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least one Jotunheim (blue) province. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_3_7`},
    {name: `Odin's Throne`, type: `Clan`, suit: `Clan`, description: `Double the glory award for quests you complete.`, url: `https://furtivespy.com/images/bloodrage/age3_3_8`},
    {name: `Eternal Dragons`, type: `Ship`, suit: `Ship`, description: `Gain 12 glory when a ship of yours is destroyed.`, url: `https://furtivespy.com/images/bloodrage/age3_3_9`},

    {name: `Tyr's Rage`, type: `Battle`, suit: `Battle`, description: `-`, url: `https://furtivespy.com/images/bloodrage/age3_4_0`},
    {name: `Frigga's Sacrifice`, type: `Clan`, suit: `Clan`, description: `As your action, you may destroy 2 of your figures to raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_4_1`},
    {name: `Frigga's Domain`, type: `Clan`, suit: `Clan`, description: `You may pay 1 rage to invade with any one of your figures in Valhalla.`, url: `https://furtivespy.com/images/bloodrage/age3_4_2`},

]

const bloodRageAge3_fivePlayer = [
    {name: `Lord of Spears`, type: `Leader`, suit: `Leader`, description: `If you successfully pillage with your leader, raise all your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_0_0`},
    {name: `Masters in Arms`, type: `Warrior`, suit: `Warrior`, description: `*Each pair of your warriors in a province is 6 total STR.`, url: `https://furtivespy.com/images/bloodrage/age3_1_7`},
    {name: `Loki's Poison`, type: `Battle`, suit: `Battle`, description: `If you lose, take the winning player's revealed cards into your hand.`, url: `https://furtivespy.com/images/bloodrage/age3_1_8`},
    {name: `Glorious Death`, type: `Quest`, suit: `Quest`, description: `Have at least 4 figures in Valhalla (before Ragnarok). If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_2_0`},
    {name: `Widespread`, type: `Quest`, suit: `Quest`, description: `Have the most STR in at least 2 different provinces. If completed, raise one of your clan stats by 1.`, url: `https://furtivespy.com/images/bloodrage/age3_2_2`},
    {name: `Tyr's Crush`, type: `Battle`, suit: `Battle`, description: `-`, url: `https://furtivespy.com/images/bloodrage/age3_2_3`},
    {name: `Eternal Dragons`, type: `Ship`, suit: `Ship`, description: `Gain 12 glory when a ship of yours is destroyed.`, url: `https://furtivespy.com/images/bloodrage/age3_2_8`},
    {name: `Tyr's Judgement`, type: `Battle`, suit: `Battle`, description: `-`, url: `https://furtivespy.com/images/bloodrage/age3_4_3`},
