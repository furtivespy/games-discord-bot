...
class Summoner extends Command {
    constructor(client){
        super(client, {
            ...
            usage: "use command followed by the number of dice to roll (if no number is added, only 1 die will be rolled)",
            enabled: true,
            guildOnly: false,
            allMessages: false,
            showHelp: true,
    ...
    async run (message, args, level) {
        try {
            ...
            const statusEmbed = new Discord.MessageEmbed().setColor(4130114).setTitle("Summoner Wars Roll").setTimestamp()
